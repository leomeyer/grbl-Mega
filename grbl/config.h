...
// Defines for BAM shield 1.0
// This board is compatible with RAMPS.
// In addition, DEFAULTS_RAMPS_BOARD must be defined.
#define BAM_BOARD_1_0
#define CPU_MAP_2560_BAM_1_0
