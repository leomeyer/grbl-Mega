...
// BAM+DICE V1.0
// http://wiki.2printbeta.de/doku.php/bam-shield
// Leo Meyer 2020-05-19
#ifdef CPU_MAP_2560_BAM_1_0 // (Arduino Mega 2560) with BAM shield 1.0
  #include "nuts_bolts.h"
  ...
  #define MIN_LIMIT_BIT_0 3 // X Limit Min - Pin D50
  #define MIN_LIMIT_BIT_1 2 // Y Limit Min - Pin D51
  #define MIN_LIMIT_BIT_2 1 // Z Limit Min - Pin D52
  #define _MIN_LIMIT_BIT(i) MIN_LIMIT_BIT_##i
  #define MIN_LIMIT_BIT(i) _MIN_LIMIT_BIT(i)
  #define MIN_LIMIT_DDR(i) _DDR(MIN_LIMIT_PORT_##i)
  #define MIN_LIMIT_PORT(i) _PORT(MIN_LIMIT_PORT_##i)
