...
/* The defaults.h file serves as a central default settings selector for different machine
  ...
  #define DEFAULT_X_STEPS_PER_MM 203.0
  #define DEFAULT_Y_STEPS_PER_MM 203.0
  #define DEFAULT_Z_STEPS_PER_MM 203.0
  #define DEFAULT_X_MAX_RATE 500.0 // mm/min
  #define DEFAULT_Y_MAX_RATE 500.0 // mm/min
  #define DEFAULT_Z_MAX_RATE 500.0 // mm/min
  #define DEFAULT_X_ACCELERATION (15.0*60.0*60.0) // 10*60*60 mm/min^2 = 10 mm/sec^2
  #define DEFAULT_Y_ACCELERATION (15.0*60.0*60.0) // 10*60*60 mm/min^2 = 10 mm/sec^2
  #define DEFAULT_Z_ACCELERATION (15.0*60.0*60.0) // 10*60*60 mm/min^2 = 10 mm/sec^2
  #define DEFAULT_X_MAX_TRAVEL 125.0 // mm
  #define DEFAULT_Y_MAX_TRAVEL 45.0 // mm
  #define DEFAULT_Z_MAX_TRAVEL 68.0 // mm
...
#ifdef BAM_BOARD_1_0
  #undef DEFAULT_INVERT_ST_ENABLE
